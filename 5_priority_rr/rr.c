...
#define NUM_PROCESSES 5  // 프로세스의 총 수
#define TIME_QUANTUM 5   // 규정 시간 
...
// 프로세스 초기값
Process process1 = {1, 0, 10, 0, 0, 0, false, NULL};
Process processes[NUM_PROCESSES - 1] = 
{
    {2, 1, 28, 0, 0, 0, false, NULL},
    {3, 2, 6, 0, 0, 0, false, NULL},
    {4, 3, 4, 0, 0, 0, false, NULL},
    {5, 4, 14, 0, 0, 0, false, NULL}
};
